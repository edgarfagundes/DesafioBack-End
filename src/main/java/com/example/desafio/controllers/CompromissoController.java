...
public class CompromissoController {
    ...
    public Compromisso updateCompromisso(@RequestBody Compromisso compromisso, Participante participante) {
        return compromissoService.update(compromisso ,participante);
    }
